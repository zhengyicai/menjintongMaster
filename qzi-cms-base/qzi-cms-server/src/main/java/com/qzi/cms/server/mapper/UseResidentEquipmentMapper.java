...
public interface UseResidentEquipmentMapper extends BaseMapper<UseResidentEquipmentPo>{
	...
	@Select("select *  from  use_resident_equipment where equipmentId = #{equipmentId}")
	public List<UseResidentEquipmentPo> findEquipmentState(@Param("equipmentId") String equipmentId);
