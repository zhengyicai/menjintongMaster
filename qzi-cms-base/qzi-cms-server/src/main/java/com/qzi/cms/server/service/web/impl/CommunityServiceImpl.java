...
public class CommunityServiceImpl implements CommunityService {
	...
	@Override
	public List<UseCommunityVo> findAll(Paging paging,String criteria) throws Exception  {
		SysUserVo userVo = commonService.findUser();
		RowBounds rwoBounds = new RowBounds(paging.getPageNumber(),paging.getPageSize());
		return communityMapper.findAll(userVo.getId(),rwoBounds,criteria);
	}
	...
	public long findCount(String criteria)  throws Exception {
		SysUserVo userVo = commonService.findUser();
		return communityMapper.findCount(userVo.getId(),criteria);
	}
